# -*- coding: utf-8 -*-
#!/usr/bin/python
#Tools make by B4t33n, Don't copy code
import os,time,sys,smtplib,requests
blue = '\x1b[94m'
lightblue = '\x1b[94m'
red = '\x1b[91m'
white = '\x1b[97m'
...
print ''
logop(' \x1b[92m\n|****************************************************| \n| Author   : Bangladesh white hat hackers      | \n| Tool     : B-BOOM                                |\n| Version  : 1.0                                     |\n| Facebook : B4t33n                               |\n| Link     : https://www.facebook.com/B4t33n/    |\n| Coded By : B4t33n                               |\n******************************************************')
...
os.system('xdg-open https://www.facebook.com/B4t33n/')
